...
class SubstratePreparation(Process, EntryData):
    ...
    method = Quantity(
        type=str,
        default="Substrate Process (MBE PDI)",
    )
    description = Quantity(
        type=str,
        description='description',
...
class MbePDIExperiment(Experiment, EntryData):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
