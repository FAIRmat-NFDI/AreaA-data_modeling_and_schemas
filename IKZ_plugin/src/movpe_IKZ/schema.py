...
from basesections_IKZ import IKZMOVPECategory
...
class BinaryOxideGrowthStep(ProcessStep):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
...
class BinaryOxideGrowth(Process, EntryData, TableData):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
    ...
    steps = SubSection(
        section_def=BinaryOxideGrowthStep,
        repeats=True,
    )


class BinaryOxideGrowths(SectionReference):
    '''
    A section used for referencing a BinaryOxideGrowth.
    '''
    reference = Quantity(
        type=BinaryOxideGrowth,
        description='A reference to a NOMAD `BinaryOxideGrowth` entry.',
        a_eln=ELNAnnotation(
            component='ReferenceEditQuantity',
            label='BinaryOxideGrowth Reference',
        ),
    )


class ComplexOxideGrowthStep(ProcessStep):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
...
class ComplexOxideGrowth(Process, EntryData, TableData):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
    ...
    steps = SubSection(
        section_def=ComplexOxideGrowthStep,
        repeats=True,
    )


class ComplexOxideGrowths(SectionReference):
    '''
    A section used for referencing a ComplexOxideGrowth.
    '''
    reference = Quantity(
        type=ComplexOxideGrowth,
        description='A reference to a NOMAD `ComplexOxideGrowth` entry.',
        a_eln=ELNAnnotation(
            component='ReferenceEditQuantity',
            label='ComplexOxideGrowth Reference',
        ),
    )
...
class MovpeBinaryOxidesIKZExperiment(Experiment, EntryData):
    ...
    m_def = Section(
        a_eln=None,
        categories=[IKZMOVPECategory],
        label='MOVPE Binary Oxides Experiment',
    )
    method = Quantity(
        type=str,
    ...
    growth_run = SubSection(
        section_def=BinaryOxideGrowths,
        repeats=True,
    )
...
class MovpeComplexOxidesIKZExperiment(Experiment, EntryData):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
        a_eln=None,
        categories=[IKZMOVPECategory],
        label='MOVPE Complex Oxides Experiment',
    )
    method = Quantity(
        type=str,
        default="Experiment (MOVPE IKZ)",
