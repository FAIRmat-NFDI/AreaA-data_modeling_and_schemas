...
class Movpe2GrowthStep(ProcessStep):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
...
class Movpe2Growth(Process, EntryData, TableData):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
    ...
    steps = SubSection(
        section_def=Movpe2GrowthStep,
        repeats=True,
    )


class Movpe2Growths(SectionReference):
    '''
    A section used for referencing a Movpe2Growth.
    '''
    reference = Quantity(
        type=Movpe2Growth,
        description='A reference to a NOMAD `Movpe2Growth` entry.',
        a_eln=ELNAnnotation(
            component='ReferenceEditQuantity',
            label='Movpe2Growth Reference',
        ),
    )


class Movpe1GrowthStep(ProcessStep):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
...
class Movpe1Growth(Process, EntryData, TableData):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
    ...
    steps = SubSection(
        section_def=Movpe1GrowthStep,
        repeats=True,
    )


class Movpe1Growths(SectionReference):
    '''
    A section used for referencing a Movpe1Growth.
    '''
    reference = Quantity(
        type=Movpe1Growth,
        description='A reference to a NOMAD `Movpe1Growth` entry.',
        a_eln=ELNAnnotation(
            component='ReferenceEditQuantity',
            label='Movpe1Growth Reference',
        ),
    )
...
class Movpe2IKZExperiment(Experiment, EntryData):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
...
class Movpe1IKZExperiment(Experiment, EntryData):
    '''
    Class autogenerated from yaml schema.
    '''
    m_def = Section(
