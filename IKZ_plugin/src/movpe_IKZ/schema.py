...
class GrowthMovpe2IKZ(Process):
    ...
    parent_sample = SubSection(section_def=ParentSampleReference, repeats=True)
    substrate = SubSection(section_def=SubstrateReference, repeats=True)
    steps = SubSection(
...
class ExperimentMovpe1IKZ(Experiment, EntryData):
    ...
    grown_sample = SubSection(section_def=GrownSampleReference)
    growth_run = SubSection(section_def=GrowthsMovpe1IKZ)
