...
class SubstrateReference(CompositeSystemReference):
    ...
    lab_id = Quantity(
        ...
        a_tabular={"name": "GrowthRun/Substrate Name"},
        a_eln=ELNAnnotation(
            component="StringEditQuantity",
            label="Substrate ID",
        ),
    ...
    #     '''
    #     The normalizer for the `SubstrateReference` class.
    #     '''
    #     super(SubstrateReference, self).normalize(archive, logger)
...
class GrownSampleReference(CompositeSystemReference):
    """
    ...
    def normalize(self, archive, logger: BoundLogger) -> None:
        """
        The normalizer for the `GrownSampleReference` class.
        """
        super(GrownSampleReference, self).normalize(archive, logger)
...
class Bubbler(ArchiveSection):
    ...
    name = Quantity(
        type=str,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Bubbler Material"},
        a_eln={"component": "StringEditQuantity", "label": "Material"},
    )
    ...
    pressure = Quantity(
        type=np.float64,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Bubbler Pressure"},
    ...
    dilution = Quantity(
        type=np.float64,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Bubbler Dilution"},
        a_eln={
            "component": "NumberEditQuantity",
            "defaultDisplayUnit": "cm ** 3 / minute",
        },
    ...
    source = Quantity(
        type=np.float64,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Source"},
        a_eln={
            "component": "NumberEditQuantity",
            "defaultDisplayUnit": "cm ** 3 / minute",
        },
    ...
    inject = Quantity(
        type=np.float64,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Inject"},
        a_eln={
            "component": "NumberEditQuantity",
            "defaultDisplayUnit": "cm ** 3 / minute",
        },
    ...
    temperature = Quantity(
        type=np.float64,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Bubbler Temp"},
        a_eln={"component": "NumberEditQuantity", "defaultDisplayUnit": "mbar"},
        unit="mbar",
    )
    partial_pressure = Quantity(
        type=np.float64,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Partial Pressure"},
        a_eln={"component": "NumberEditQuantity", "defaultDisplayUnit": "mbar"},
        unit="mbar",
    )
    molar_flux = Quantity(
        type=np.float64,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Bubbler Molar Flux"},
        a_eln={"component": "NumberEditQuantity", "defaultDisplayUnit": "mol / minute"},
        unit="mol / minute",
    )
...
class GasSource(ArchiveSection):
    ...
    m_def = Section(label_quantity="material")
    material = Quantity(
        type=str,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Gas Material"},
        a_eln={"component": "StringEditQuantity"},
    )
    mass_flow_controller = Quantity(
        type=np.float64,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Gas MFC"},
        a_eln={
            "component": "NumberEditQuantity",
            "defaultDisplayUnit": "cm ** 3 / minute",
        },
    ...
    molar_flux = Quantity(
        type=np.float64,
        description="FILL THE DESCRIPTION",
        a_tabular={"name": "GrowthRun/Gas Molar Flux"},
        a_eln={"component": "NumberEditQuantity", "defaultDisplayUnit": "mbar"},
        unit="mbar",
    )
...
class DepositionControlMovpe1IKZ(Process, PlotSection, EntryData, TableData):
    ...
    grown_sample = SubSection(section_def=GrownSampleReference)
...
class GrowthStepMovpe2IKZ(ProcessStep):
    ...
    showerhead_distance = Quantity(
        ...
        a_tabular={"name": "GrowthRun/Distance of Showerhead"},
...
class GrowthMovpe2IKZ(Process):
    ...
    samples = SubSection(
        section_def=GrownSampleReference,
        description="""
        The samples as that have undergone the process.
        """,
        repeats=True,
    ...
    substrate = SubSection(
        section_def=SubstrateReference, repeats=True, label="Substrate"
    )
    steps = SubSection(
...
class GrowthMovpe1IKZReference(SectionReference):
    """
...
class ExperimentMovpe2IKZ(Experiment, EntryData):
    ...
    growth_runs = SubSection(
        section_def=GrowthMovpe2IKZ,
        repeats=True,
    )
...
class ExperimentMovpe1IKZ(Experiment, EntryData):
    ...
    grown_sample = SubSection(section_def=GrownSampleReference)
    growth_run = SubSection(section_def=GrowthMovpe1IKZReference)
    deposition_control = SubSection(section_def=DepositionControls)
    ...
    def normalize(self, archive, logger):
        ...
        if self.constant_parameters_id and not self.growth_run:
            ...
            for growth_entry in search_result.data:
                if (
                    self.constant_parameters_id
                    == growth_entry["results"]["eln"]["lab_ids"][0]
                ):
                    found_id = True
                    self.growth_run = GrowthMovpe1IKZReference(
            ...
            if not found_id:
                logger.warning(
                    f"The ID '{self.constant_parameters_id}' was not found in any 'GrowthsMovpe1IKZ' entry in Nomad. Check if it exist and try to reference it manually."
                )
        else:
            logger.warning(
                "No 'Constant Parameters ID' was found in Experiment. The corresponding 'GrowthsMovpe1IKZ' dataset couldn't be referenced."
            )
