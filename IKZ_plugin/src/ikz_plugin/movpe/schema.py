...
from IKZ_plugin.src.ikz_plugin import IKZMOVPECategory, IKZMOVPE1Category, IKZMOVPE2Category
...
class PureSubstanceComponentMovpe1IKZ(
    PureSubstanceComponent
):  # TODO remove this class if not needed anymore (remove tabular)
    """
...
class GrowthMovpe2IKZ(
    VaporDeposition, EntryData
):  # Process # TODO should it be ExperimentStep ?
    """
    Class autogenerated from yaml schema.
    """
...
class ExperimentMovpe2IKZ(Experiment, EntryData):
    ...
    def normalize(self, archive, logger):
        archive.workflow2 = None
        super(ExperimentMovpe2IKZ, self).normalize(archive, logger)
