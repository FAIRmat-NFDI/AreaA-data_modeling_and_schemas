...
class DigitalProtocol(PlotSection, Process, EntryData): #, TableData):
    ...
    def normalize(self, archive, logger: BoundLogger):
        ...
        if self.digital_protocol_file:
            with archive.m_context.raw_file(self.digital_protocol_file, 'r', encoding='unicode_escape') as file:
                ...
                for line in file:
                    ...
                    clean_file += mod_line
                df_csv=pd.read_csv(io.StringIO(clean_file), sep=';', decimal=",", engine='python')
...
class DirectionalSolidificationExperiment(Experiment, EntryData):
    ...
    def normalize(self, archive, logger: BoundLogger) -> None:
        ...
        if self.digital_protocol_file:
            ...
            create_archive(digital_protocol_archive.m_to_dict(), archive.m_context, filename, filetype, logger)
            setattr(digital_protocol_archive, 'reference', f'../uploads/{archive.m_context.upload_id}/archive/{hash(archive.m_context.upload_id, filename)}#data')
