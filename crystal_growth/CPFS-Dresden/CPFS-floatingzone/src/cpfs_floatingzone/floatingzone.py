...
class CPFSFloatingZoneProcessStep(FloatingZoneProcessStep,EntryData):
    def normalize(self, archive, logger: BoundLogger) -> None:
        ...
        '''
        super(FloatingZoneProcessStep, self).normalize(archive, logger)


class CPFSFloatingZoneProcess(FloatingZoneProcess, EntryData):
    '''
